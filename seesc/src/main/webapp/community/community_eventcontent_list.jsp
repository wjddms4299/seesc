        ...
        %>
           ...
           if(arr.get(i).getWrite_lev()>0){
        	   ...
        	   if(manager==1||user_idx==arr.get(i).getUser_idx()&&user_idx!=0){%>
        	   		<b style="color:red;">[Close]</b><br><a style="text-decoration:none;" href="community_eventcontent_content.jsp?write_idx=<%=arr.get(i).getWrite_idx() %>"><b style="color:#FFA300;">&nbsp;공개 예정&nbsp;</b></a>
        	   <%}else{%>

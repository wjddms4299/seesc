	...
	<section>
		<article>
			...
			<table class="write_table">
				<thead>
					<tr>
						<td colspan="4" align="left">전체글 : <%=totalqna%>개
						</td>
				...
				<tfoot>
					<tr>
						<td colspan="4" align="center"><select name=>
								<option value="1">글제목</option>
								<option value="2">내용</option>
								<option value="3">작성자</option>
						</select> <input type="text" name="search" placeholder="내용입력" required = "required"> <input
